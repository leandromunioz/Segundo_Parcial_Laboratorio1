...
/// @brief funcion que filtra solo la editorial minotauro y devuelve la lista
/// @param this
/// @param fn
/// @return devuelve la lista obtenida
LinkedList* ll_filter(LinkedList *this, int (*fn)(void *element));

/// @brief funcion que recorre una lista y la mapea
/// @param this
/// @param fn
/// @return devuelve -1 en caso de error y 0 en caso exito
